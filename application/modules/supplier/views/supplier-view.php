        ...
        <tr>
            ...
            <td class="actions btn-group-xs text-center status">
                ...
                <?php if (hasPermission("supplier_info", DELETE)) : ?>
                    <a href="<?php echo site_url("supplier/delete/" . $value['supplier_id']); ?>" title="Delete" class="deleteRow text-danger btn btn-default  btn-xs  waves-effect tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View" id="course"><i class="fa fa-trash"></i></a>
                <?php endif; ?>
            </td>
        </tr>
    <?php endforeach; ?>
