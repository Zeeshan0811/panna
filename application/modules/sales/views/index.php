                            ...
                            <div class="panel-body">
                                <form id="temp_stock_form" class="temp_stock_form">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="sales_type_id">Sales Type</label><small class="req"> *</small> 
                                                <select name="sales_type_id" id="sales_type_id" required class="form-control selectpicker">
                                                    <?php if(isset($all_sales_type)): ?>
                                                        <?php foreach($all_sales_type as $value): ?>
                                                            <option <?php if(strtoupper($value['name'])=="SALES OF PRODUCT") echo "selected"?> value="<?php echo $value['id'] ?>#<?= $value['name'] ?>"><?= $value['name'] ?></option>
                                                        <?php endforeach;?>
                                                    <?php endif;?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-btn customer_add_plus">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <?php echo form_open("sales/add"); ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="ol-md-12 m-t-10 col-sm-12 col-xs-12">
                                                            <button type="submit" id="final_save_button" style="display:none" class="btn btn-info btn-xs pull-right">Save</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="sales_type_id">Sales Type</label><small class="req"> *</small> 
                                                <select name="sales_type_id" id="sales_type_id" required class="form-control selectpicker">
                                                    <?php if($single['sales_type']!="Damage"): ?>
                                                        <?php if(isset($all_sales_type)): ?>
                                                            <?php foreach($all_sales_type as $value): ?>
                                                                    <?php if($value['name']!="Damage"): ?>
                                                                    <option <?php if($value['id']==$single['sales_type_id']) echo "selected" ?> value="<?php echo $value['id'] ?>#<?= $value['name'] ?>"><?= $value['name'] ?></option>
                                                                    <?php endif;?>
                                                                <?php endforeach;?>
                                                        <?php endif;?>
                                                    <?php else: ?>
                                                        <option  value="<?php echo $single['sales_type_id'] ?>#<?= $single['sales_type'] ?>"><?= $single['sales_type'] ?></option>
                                                    <?php endif;?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="marketing">Marketing</label><small class="req"> *</small> 
                                                <input type="text"  readonly value="<?php if($single['marketing_name']!='') echo $single['marketing_name']; else echo $single['branch_name']; ?>" name="marketing" id="marketing" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                                ...
                                                                <table class="table table-small-font table-bordered purchase_form_table">
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <select name="bank_name" required disabled  id="bank_name" data-live-search="true"  class="purchase_form form-control selectpicker">
                                                                            ...
                                                                            <?php if(isset($all_bank)): ?>
                                                                                <?php foreach($all_bank as $value): ?>
                                                                                    <option <?php if($single_sales_amount->bank_id==$value['id']) echo "selected";  ?> value="<?php echo $value['id'] ?>"><?php echo $value['name'] ?></option>
                                                                                <?php endforeach;?>
                                                                            <?php endif;?>
                                                                        </select>
                                                                        </td>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            <input name="sales_type_id" readonly  id="sales_type_id" value="<?php echo @$single_sales_amount->sales_type; ?>" type="hidden" class="form-control purchase_form">
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Current Payable</label> </td>
                ...
                <div class="modal-body"> 
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="input-group">
                                <select name="marketing_id" id="marketing_id" data-live-search="true"  class="form-control selectpicker">
                                        <option value="">--Select</option>
                                    </select>
                                    <div class="input-group-btn">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="tel" placeholder="Telephone No."  class="form-control" required id="tel" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="national_id" placeholder="National Id No." class="form-control" required id="national_id" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="trade">Trade License</label> 
                                <input type="text" name="trade" placeholder="Trade License No." class="form-control" required id="trade" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="security_cheque">Sec. Cheque No.</label>
                                <input type="text" name="security_cheque" placeholder="Security Cheque No."  class="form-control" required id="security_cheque" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="amount">Amount</label> 
                                <input type="text" name="amount" placeholder="Amount" class="form-control" required id="amount" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="bank_id">Bank Name</label>
                                <select name="bank_id" id="bank_id" data-live-search="true" class="form-control selectpicker">
                                    <option value="">--Select--</option>
                                    <?php if(isset($all_bank)): ?>
                                        <?php foreach($all_bank as $value): ?>
                                            <option value="<?php echo $value['id'] ?>"><?php echo $value['name'] ?></option>
...
<script>
    $(document).ready(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data!=null)
                    {
                        ...
                        if(data.marketing_name!=null)
                        {
                            $("#marketing").val(data.marketing_name);
                        }else{
                            $("#marketing").val($("#temp_stock_form #branch_id").val().split("#")[1]);
                        }
                        $("#temp_stock_form #account_id").val(data.ledger_id);
                    }
                    else{
                        $("#temp_stock_form #account_id").val('');
                        $("#customer_code").val('');
                        $("#marketing").val("");
                    }
                }
        ...
        //sales type
        sales_type_id();
        $("#sales_type_id").on("change",function(e){
            e.preventDefault();
            sales_type_id();
        });
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.msg=="id")
                    {
                        ...
                        if(data.result_data!=''){
                            $("#price").val(data.result_data.sale_price);
        ...
        function get_sales_item()
        {
            ...
            var customer=$("#temp_stock_form #customer_id").val();
            var customer_id='';
            if(customer!=null)
            {
            ...
            $.ajax({
                url:url,
                type:"get",
                data:{"customer_id":customer_id,"company_id":company_id,"branch_id":branch_id},
                success:function(data){
                    var html = '';
        ...
        function sales_type_id() {
            var value=$("#sales_type_id").val().split("#")[1];
            // console.log()
            if(value==="Damage"){
        ...
        $(".temp_stock_form").on("submit",function(e){
            ...
            ledger_data.push(customer_id);
            sales_data.push(sales_type_id);
            if(!allEqual(ledger_data))
            {
                $.Notification.autoHideNotify('error', 'top right',"Keep Customer Same");
                removeLedger(ledger_data,customer_id);
                return;
            }
            if(!allEqual(sales_data))
            {
                $.Notification.autoHideNotify('error', 'top right',"Keep Sales Type Same");
                removeLedger(sales_data,sales_type_id);
                return;
            }
            ...
            $.each(store_data,function(key,value){
                html = '<tr id="'+value.item_desc_id+'">' +
                    ...
                    '<input type="hidden" name="sales_type_id" value="'+value.sales_type_id+'" >'+
                    '<input type="hidden" name="marketing" value="'+value.marketing+'" >'+
        ...
        function removeLedger(array, id){
        ...
        *=========================
        ...
        function calculate_multiple_value()
        {
            ...
            if(store_data.length<=0)
            {
                $("#final_save_button").hide();
            }else{
                $("#final_save_button").show();
            }
        }
