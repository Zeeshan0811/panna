<div class="content">
    <?php $data['msg']="Welcome To Sales Return"; ?>
    <?php $this->load->view("message",$data) ?>
    <div class="container">
        <?php  if(hasPermission("sales_return",ADD)): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-body">
                                <form id="temp_stock_form" class="temp_stock_form">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="customer_id">Customer</label><small class="req"> *</small> 
    ...
    $(document).ready(function(){
        ...
        function get_item()
        {
            ...
            $.ajax({
                ...
                type:"get",
                dataType:"json",
                data:{"status":1,"invoice_no":invoice_no,"sales_return":"sales_return"},
        ...
        function get_customer(){
            var invoice_no=$("#invoice_no").val();
            var url="<?php echo base_url(); ?>ajax/get_customer_by_invoice";
            $.ajax({
                url:url,
                type:"get",
                dataType:"json",
                ...
                success:function(data){
                    ...
                    if(data!=null){
                        $("#temp_stock_form #customer_id").append('<option value="'+ data.id +'#'+data.name+'">'+ data.name +'</option>')
        ...
        $('#item_id').on('change',function(e){
            ...
            var item=$.ajax({
                ...
                type:"get",
                dataType:"json",
                data:{"item_id":item_id,"invoice_no":invoice_no,"sales_return":"sales_return"},
                success:function(data){
                    replace_item_code_and_item_desc(data.result_data);
                }
            });
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.msg=="id")
                    {
                        ...
                        if(data.result_data!=''){
                            $("#price").val(data.result_data.sales_price);
        ...
        *=========================
        ...
        $("#final_submit").on("submit",function(e){
            ...
            if(store_data.length>0)
            {
                ...
                var url="<?php echo base_url(); ?>sales/sales_return";
                $.ajax({
                    url:url,
                    type:"post",
                    dataType:"json",
