        ...
        <tr>
            ...
            <td class="actions btn-group-xs text-center status">
                ...
                <?php if (hasPermission("customer_info", DELETE)) : ?>
                    <a href="<?php echo site_url("customer/delete/" . $value['customer_id']); ?>" title="Delete" class="text-danger btn btn-default  btn-xs  waves-effect tooltips deleteRow" data-placement="top" data-toggle="tooltip" data-original-title="View" id="course"><i class="fa fa-trash"></i></a>
                <?php endif; ?>
            </td>
        </tr>
    <?php endforeach; ?>
