                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="actions btn-group-xs text-center">
                                                            ...
                                                            <?php if (hasPermission("customer_bank", DELETE)) : ?>
                                                                <a href="<?php echo site_url("customer/deleteBank/" . $value['id']); ?>" title="Delete" class="text-danger btn btn-default  btn-xs  waves-effect tooltips deleteRow" data-placement="top" data-toggle="tooltip" data-original-title="View" id="course"><i class="fa fa-trash"></i></a>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
