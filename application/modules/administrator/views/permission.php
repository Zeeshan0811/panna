<div class="content">
    <?php $data['msg']="Welcome To Permission Setup"; ?>
                                                    ...
                                                    <?php if(hasPermission($value['group_code'],VIEW) && hasActive($value['group_code'])):?>
                                                        <tr>
                                                            ...
                                                            <?php if (!empty($value['permission'])): ?>
                                                                    ...
                                                                    <td>
                                                                        <?php if($value['permission'][0]['enable_view'] == 1): ?>
                                                                            <label class="">
                                                                    ...
                                                                    <td>
                                                                        <?php if($value['permission'][0]['enable_add'] == 1): ?>
                                                                            <label class="">
                                                                    ...
                                                                    <td>
                                                                        <?php if($value['permission'][0]['enable_edit'] == 1): ?>
                                                                        <label class="">
                                                                    ...
                                                                    <td>
                                                                        <?php if($value['permission'][0]['enable_delete'] == 1): ?>
                                                                        <label class="">
