<div class="content">
    <?php $data['msg'] = "Welcome To Menu Setup"; ?>
            ...
            <div class="row">
                ...
                <?php if (isset($add)) : ?>
                    <div class="col-sm-8">
                        <div class="panel panel-border panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">Module Category</h3>
                            </div>
                            <div class="panel-body">
                                                        ...
                                                        <?php if (!empty($value['category'])) : ?>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($value['category'][0]['short_code'] == $value['short_code']) : ?>
                                                                    ...
                                                                    <a class="btn btn-danger btn-xs deleteRow " href="<?php echo  site_url("administrator/module/delete/" . $value['group_id'] . '/' . $value['category'][0]['cat_id'] . "/parent") ?>"><i class="fa fa-trash"></i></a>
                                                                <?php else : ?>
                                                                    ...
                                                                    <a class="btn btn-danger btn-xs deleteRow" href="<?php echo  site_url("administrator/module/delete/" . $value['category'][0]['cat_id']) ?>"><i class="fa fa-trash"></i></a>
                                                                <?php endif; ?>
                                                            </td>
                                                        <?php else : ?>
                                                            <td colspan="7"></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <?php if ($new_feature_value['short_code'] == $value['short_code']) : ?>
                                                                        ...
                                                                        <a class="btn btn-danger btn-xs deleteRow" href="<?php echo  site_url("administrator/module/delete/" . $value['group_id'] . '/' . $new_feature_value['cat_id'] . "/parent") ?>"><i class="fa fa-trash"></i></a>
                                                                    <?php else : ?>
                                                                        ...
                                                                        <a  class="btn btn-danger btn-xs deleteRow" href="<?php echo  site_url("administrator/module/delete/" . $new_feature_value['cat_id']) ?>"><i class="fa fa-trash"></i></a>
                                                                    <?php endif; ?>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
