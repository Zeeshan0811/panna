<div class="content">
    <?php $data['msg']="Welcome To Purchase"; ?>
                                                            ...
                                                            <fieldset>
                                                                <table class="table table-small-font table-bordered purchase_form_table">
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="text-center"><input disabled value="<?php echo date("d-m-Y") ?>" required name="cheque_date"  id="cheque_date" type="text" readonly class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Matured Date</label></td>
                                                                        <td class="text-center"><input disabled value="<?php echo date("d-m-Y") ?>" required name="mature_date"  id="mature_date" type="text" readonly class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                        ...
                                                        <div class="col-md-6">
                                                            <fieldset>
                                                                <table class="table table-small-font  table-bordered purchase_form_table">
                                                                    ...
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Vat(%)</label> </td>
                                                                        <td class="text-center">
                                                                            <input name="vat"  id="vat" type="text" class="form-control purchase_form">
                                                                            <input name="after_vat_total"  id="after_vat_total" type="hidden" class="form-control purchase_form">
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="text-center"><input name="pay" readonly id="pay" type="text"  class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
            ...
            <?php if(isset($edit)): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-body">
                                <!-- <form id="temp_stock_form" class=""> -->
                                <?php echo form_open("purchase/edit/".$single_item_stock['id'],array("id"=>"temp_stock_form")) ?>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="company_id">Company Name</label><small class="req"> *</small> 
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="account_id">Account</label><small class="req"> *</small> 
                                                <select name="account_id" id="account_id" data-live-search="true" required class="form-control selectpicker">
                                                    <option value="<?php echo $single_item_stock['account_id'] ?>"><?php echo $single_item_stock['account_head_name'] ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label for="invoice_no">Invoice No.</label><small class="req"> *</small> 
                                                <input type="text" name="invoice_no" value="<?php echo $single_item_stock['invoice_no'] ?>"  class="form-control" required id="invoice_no" >
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="date">Date</label><small class="req"> *</small> 
                                                <input type="text" value="<?php echo date("d-m-Y",strtotime($single_item_stock['date'])) ?>" readonly name="date" id="date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="due_date">Due Date</label><small class="req"> *</small> 
                                                <input type="text" readonly name="due_date" <?php echo date("d-m-Y",strtotime($single_item_stock['due_date'])) ?> id="due_date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group pull-left m-t-22 ">
                                                <button name="" type="submit" class="btn btn-success "><i class="md md-add m-r-5"></i>Update</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="row ">
                                    <div class="col-md-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <!-- <form id=""> -->
                                                <?php echo form_open("purchase/editMain/".$single_stock_amount->id); ?>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <fieldset>
                                                                <table class="table table-small-font table-bordered purchase_form_table">
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="text-center">
                                                                        <select name="payment_option"  id="payment_option" required class="form-control purchase_form selectpicker">
                                                                            <option <?php if($single_stock_amount->payment_option=="Ledger") echo "selected"; ?> value="Ledger">Ledger</option>
                                                                            <option <?php if($single_stock_amount->payment_option=="Cash") echo "selected"; ?> value="Cash">Cash</option>
                                                                            <option <?php if($single_stock_amount->payment_option=="Bank") echo "selected"; ?> value="Bank">Bank</option>
                                                                        </select>
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <select name="bank_name" required disabled  id="bank_name" data-live-search="true"  class="purchase_form form-control selectpicker">
                                                                            ...
                                                                            <?php if(isset($all_bank)): ?>
                                                                                <?php foreach($all_bank as $value): ?>
                                                                                    <option <?php if($single_stock_amount->bank_id==$value['id']) echo "selected";  ?> value="<?php echo $value['id'] ?>"><?php echo $value['name'] ?></option>
                                                                                <?php endforeach;?>
                                                                            <?php endif;?>
                                                                        </select>
                                                                        </td>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Cheque No.</label></td>
                                                                        <td class="text-center"><input disabled required name="cheque_no" value="<?php echo @$single_stock_amount->cheque_no; ?>"  id="cheque_no" type="text" class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Cheque date</label></td>
                                                                        <td class="text-center"><input disabled required name="cheque_date"  id="cheque_date" value="<?php echo @$single_stock_amount->cheque_date; ?>" type="text" readonly class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Matured Date</label></td>
                                                                        <td class="text-center"><input disabled required name="mature_date" value="<?php echo @$single_stock_amount->mature_date; ?>" id="mature_date" type="text" readonly class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Total</label> </td>
                                                                        <td class="text-center"><input name="total" value="<?php echo @$single_stock_amount->total; ?>" readonly  id="total" type="text" class="form-control purchase_form"></td>
                                                                    </tr>
                                                                </table>
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <fieldset>
                                                                <table class="table table-small-font  table-bordered purchase_form_table">
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Discount.</label></td>
                                                                        <td class="text-center"><input name="discount" value="<?php echo @$single_stock_amount->discount; ?>" id="discount" type="text" class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Vat(%)</label> </td>
                                                                        <td class="text-center">
                                                                            <input name="vat"  id="vat" value="<?php echo @$single_stock_amount->vat; ?>" type="text" class="form-control purchase_form">
                                                                            <input name="after_vat_total"  id="after_vat_total" type="hidden" value="<?php echo @$single_stock_amount->after_vat_total; ?>" class="form-control purchase_form">
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Load Charge</label></td>
                                                                        <td class="text-center">
                                                                            <input name="load_charge" value="<?php echo @$single_stock_amount->load_charge; ?>"  id="load_charge" type="text"  class="form-control purchase_form">
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Grand Total</label></td>
                                                                        <td class="text-center"><input name="grand_total" value="<?php echo @$single_stock_amount->grand_total; ?>"  id="grand_total" type="text" readonly class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Pay</label></td>
                                                                        <td class="text-center"><input name="pay" readonly id="pay" value="<?php echo @$single_stock_amount->pay; ?>" type="text"  class="form-control purchase_form"></td>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        <td class="text-center"><label for="">Due</label></td>
                                                                        <td class="text-center"><input name="due"  id="due" type="text" value="<?php echo @$single_stock_amount->due; ?>" readonly class="form-control purchase_form"></td>
                                                                    </tr>
                                                                </table>
                                                            </fieldset>
                                                        </div>
    ...
    $(document).ready(function(){
        ...
        $(".temp_stock_form").on("submit",function(e){
            ...
            if(!allEqual(invoice_data))
            {
                ...
                removeSuppplier(invoice_data,invoice_no);
                return;
            }
            ...
            var url="<?php echo base_url() ?>purchase/check_exits_invoice";
            $.ajax({
                type:"post",
                url:url,
                dataType:"json",
                data:{"invoice_no":invoice_no,"company_id":company_id},
                success:function(data){
                    if(data.msg=="error")
                    {
                        $.Notification.autoHideNotify('error', 'top right',"This Invoice alerady exits!");
                        removeSuppplier(invoice_data,invoice_no);
                    }else{
        ...
        function store_data_show() {
            ...
            $.each(store_data,function(key,value){
                html = '<tr id="'+value.item_desc_id+'">' +
                    ...
                    '<input type="hidden" name="id[]" value="'+value.company_id+'" >'+
        ...
        function removeSuppplier(array, id){
        ...
        *=========================
        ...
        function calculate_multiple_value()
        {
            ...
            $("#after_vat_total").val(total_sub_total);
        ...
        $("#vat").on("change",function(){
            ...
            if(isNaN(vat) && vat>100)
            {
                vat=0;
            }
            var total_vat_tk=(total*vat)/100;
            var grandTotal=total_vat_tk+parseFloat(total)-discount+parseFloat(load_charge);
            if(isNaN(grandTotal))
            {
                grandTotal=0;
            }
            if(grandTotal>0)
            {
                ...
                $("#after_vat_total").val(grandTotal+parseFloat(discount)+parseFloat(load_charge));
                $("#due").val(grandTotal);
            }else{
                $("#grand_total").val(total-discount-load_charge);
                $("#after_vat_total").val(total);
                $("#due").val(total-discount-load_charge);
            }
        });
        ...
        $("#discount").on("change",function(){
            $("#pay").val("");
            var total=parseFloat($("#after_vat_total").val()).toFixed(2);
            var discount=parseFloat($("#discount").val()).toFixed(2);
            var load_charge=parseFloat($("#load_charge").val()).toFixed(2);
            if(isNaN(total))
            {
            ...
            if(isNaN(discount) || (discount<0 && discount>total))
            {
                discount=0;
            }
            if(isNaN(load_charge))
            ...
            var grandTotal=total-discount+parseFloat(load_charge);
            if(grandTotal>0)
            {
                $("#grand_total").val(grandTotal);
                $("#due").val(grandTotal);
        ...
        $("#load_charge").on("change",function(){
            $("#pay").val("");
            var after_vat_total=parseFloat($("#after_vat_total").val()).toFixed(2);
            var load_charge=parseFloat($("#load_charge").val()).toFixed(2);
            var discount=parseFloat($("#discount").val()).toFixed(2);
            if(isNaN(after_vat_total))
            {
                after_vat_total=0;
            }
            if(isNaN(load_charge) ||load_charge<0)
            {
                load_charge=0;
            }
            if(isNaN(discount))
            ...
            var grandTotal=parseFloat(after_vat_total)+parseFloat(load_charge)-discount;
            if(grandTotal>0)
            {
                $("#grand_total").val(grandTotal);
                $("#due").val(grandTotal);
            }else{
                $("#load_charge").val(after_vat_total);
                $("#grand_total").val(0);
                $("#due").val(0);
            }
        });
