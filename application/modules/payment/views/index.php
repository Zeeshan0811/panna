<div class="content">
    <?php $data['msg']="Welcome To Payment"; ?>
    <?php $this->load->view("message",$data) ?>
    <div class="container">
        <div class="no_print">
            <?php  if(hasPermission("payment",ADD)): ?>
                <?php if(isset($add)): ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel ">
                                <div class="panel-body">
                                    <form id="payment_form">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="ledger_id">Pay To</label><small class="req"> *</small> 
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly name="address" placeholder="Address" class="form-control" required id="address" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="">Payment</label><small class="req"> *</small> 
                                                    <select name="payment_option"  id="payment_option" required class="form-control  selectpicker">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pay_by" readonly value="<?php echo logged_in_name(); ?>" placeholder="Pay By"  class="form-control"  id="pay_by" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                ...
                <?php if(isset($edit)): ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel ">
                                <div class="panel-body">
                                    <?php echo form_open("payment/edit/".$single['id']) ?>
                                    <!-- <form id="payment_form"> -->
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="">Payment</label><small class="req"> *</small> 
                                                    <select name="payment_option"  id="payment_option" required class="form-control  selectpicker">
                                                        <option <?php if($single['pay_type']=="Cash") echo "selected"; ?> value="Cash">Cash</option>
                                                        <option <?php if($single['pay_type']=="Bank") echo "selected"; ?> value="Bank">Bank</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="amount">Amount</label><small class="req"> *</small> 
                                                    <input type="text" name="amount" value="<?php echo $single['debit'] ?>" placeholder="Amount" required class="form-control" required id="amount" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="pay_by">Pay By</label>
                                                    <input type="text" readonly value="<?= $single['pay_by'] ?>" name="pay_by" placeholder="Pay By"  class="form-control"  id="pay_by" >
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group pull-left m-l-15 ">
    ...
    $(document).ready(function(){
       ...
       <?php if(!isset($edit)): ?>
        ...
        function get_custom_receive_no() {
            var url="<?php echo base_url(); ?>payment/received_no";
            $.ajax({
                url:url,
                type:"get",
                dataType:"json",
        ...
        function get_ledger_address() {
            ...
            $.ajax({
                ...
                type:"get",
                dataType:"json",
                data:{"ledger_id":ledger_id,"type":"supplier"},
                success:function(data){
                    if(data!=null)
                    {
        ...
        function get_ledger()
        {
            ...
            $.ajax({
                ...
                type:"get",
                dataType:"json",
                data:{"company_id":company_id,"branch_id":branch_id,"type":"payment"},
                success:function(data){
        ...
        function get_payment()
        {
            ...
            var company_id=$("#company_id").val();
            var ledger_id=$("#ledger_id").val();
            var url="<?php echo base_url(); ?>payment/get_payment";
            $.ajax({
                url:url,
                type:"get",
                dataType:"json",
