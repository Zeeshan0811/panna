        ...
        <tr>
            ...
            <td class="actions btn-group-xs text-center">
                ...
                <?php if (is_super_admin()) : ?>
                    <a onclick="return confirm('Are You sure want to delete this?')" href="<?php echo site_url("branch/branchDelete/" . $value['branch_id']); ?>" title="Delete" class="text-danger btn btn-default  btn-xs  waves-effect tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View" id="course"><i class="fa fa-trash"></i></a>
                <?php endif; ?>
            </td>
        </tr>
    <?php endforeach;?>
