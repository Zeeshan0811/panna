                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions btn-group-xs text-center">
                                                        ...
                                                        <?php if (hasPermission("unit", DELETE)) : ?>
                                                            <a onclick="return confirm('Are You Sure?')" href="<?php echo site_url("unit/delete/" . $value['id']); ?>" title="Delete" class="text-danger btn btn-default  btn-xs  waves-effect tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View" id="course"><i class="fa fa-trash"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach;?>
