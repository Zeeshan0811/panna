...
<head>
    ...
    <title><?php echo $this->company_name; ?> | <?php echo $title_for_layout; ?></title>
    ...
    <!--calendar css-->
    <link href="<?php echo VENDOR_URL; ?>fullcalendar/fullcalendar.css" rel="stylesheet" />
    <link href="<?php echo VENDOR_URL; ?>jquery-multi-select/multi-select.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo VENDOR_URL; ?>summernote/summernote.css" rel="stylesheet" type="text/css" />
