        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> Sign In to <strong><?= DC ?></strong> </h3>
                </div> 
                ...
                <?php echo form_open("auth/login",array("class"=>"form-horizontal m-t-20")); ?>
                    ...
                    <div class="form-group m-t-30 text-center">
                        <div class="col-sm-12">
                            <a href="<?php echo site_url("auth/forgot"); ?>"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                        </div>
                    </div>
                </form> 
                </div>                                 
