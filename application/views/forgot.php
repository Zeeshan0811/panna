    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <?php echo form_open("auth/forgotpass",array("class"=>"form-horizontal m-t-20")); ?>
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg w-lg waves-effect waves-light" type="submit">Reset</button>
                        </div>
                    </div>
                </form> 
                </div>                                 
