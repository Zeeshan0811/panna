...
class Welcome extends MY_Controller {
	...
	{
		$this->session->set_userdata('top_menu', $module);
        $this->session->set_userdata('sub_menu'," $module");
		$this->session->set_userdata('set_active', $module);
		$this->session->set_userdata("menu_code",$module);
		$module=str_replace("_"," ",$module);
		$module=ucwords($module);
		$this->data['msg']="Welcome To ".$module;
        $this->layout->title("$module");
		$this->layout->view('welcome',$this->data);
		// $menu_code=$this->session->userdata("menu_code"); 
		// $submenu=get_submenu($menu_code);
		// debug_r($submenu);
	}
